...
<?php
	...
	$con_explain = mysqli_connect("$ip","$user","$pwd","$dbname","$port") or die("数据库链接错误".mysqli_error());
...
<?php
	...
	//禁止字符串转义stripcslashes函数
	$sql_advisor_export = stripcslashes($sql_advisor_export);
